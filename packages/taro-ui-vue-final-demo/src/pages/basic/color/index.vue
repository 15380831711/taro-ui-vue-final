 ...
 * @LastEditors: pengyue
 * @Description: 
 * @FilePath: /taro-ui-vue-final/packages/taro-ui-vue-final-demo/src/pages/basic/color/index.vue
-->
<template>
  <view>
    <DocsHeader title="Color 颜色" />
    <view class="doc-body">
      <view v-for="(item, index) in colorData" :key="index" class="panel">
